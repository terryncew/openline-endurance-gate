...
INT_FIELDS = {
    ...
    "top_decile_capture", "new_node_depth", "violation", "system_failure", "active_unresolved", "active_tips",
    ...
    "unresolved_count", "node_age", "branch_age", "is_tip", "depth", "capture_count_window",
    "child_count", "shielded_cycles", "branch_size", "label", "tip_depth", "receipt_used", "success",
    "recovery_cost",
}
FLOAT_FIELDS = {
