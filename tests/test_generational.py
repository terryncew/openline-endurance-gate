...
def test_saved_run_analysis_recomputes_summary():
    ...
    # This exact fixture is release evidence produced under Python 3.12+.
    # The release workflow pins that runtime family, so any difference remains
    # a hard failure rather than being hidden behind a numeric tolerance.
